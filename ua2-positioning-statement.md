...
- **Basis for the belief:** Origin interview with friend (birdwatcher/conservationist). She described frustration with switching between multiple apps and databases. She's not a researcher but actively digs into population data to understand ecological change. Student's instinct that habitat protectors — not casual hikers or researchers — would care most about multi-year trend data.
- **Evidence found:**
  - 2026-06-26, origin interview: Friend described bridging eBird, BirdonMap, GIS tools, and academic portals to answer one ecological question (post-wildfire species recovery). Said "there isn't a unified space that connects casual field logging with deep, meaningful data analysis."
- **Alternatives considered:** Casual hiker (too low motivation to use deep data); serious researcher (already has professional tools); general learner (too broad, doesn't explain why multi-year data matters to them)
- **What would change my mind:** If interviews show that people who care about conservation already have tools they're happy with, or that the real pain point belongs to a different user type.
...
- **Current belief:** Birdpoint
- **Basis for the belief:** Student chose it for simplicity. "Bird" is front and center; "point" references data points and the project's data-driven focus.
- **Evidence found:** (none — name is internal, thin evidence acceptable)
- **Alternatives considered:** Birdmark, Aviary, NestData, FlockMap — all dropped for feeling too niche or too generic.
- **What would change my mind:** If users find the name confusing or it conflicts with an existing product.

> Mostly internal; thin evidence here is acceptable.

### Product category

- **Current belief:** Interactive data tool
- **Basis for the belief:** Student chose it as more precise than "educational app" — reflects the hands-on, data-driven nature of the product.
- **Evidence found:** (none yet)
- **Alternatives considered:** Educational app (too passive), conservation app (implies action over learning), platform (too broad)
- **What would change my mind:** If users describe themselves as looking for an "app" or "map" rather than a "tool" — category expectations shape what they expect to find inside.
...
- **Basis for the belief:** Origin interview — friend had to bridge multiple tools to get population trend data. The app removes that friction and puts the data in front of the user directly.
- **Evidence found:**
  - 2026-06-26, origin interview: Friend described needing to "bridge the gap between casual birding apps and actual academic or university research databases" to get real population numbers.
- **Alternatives considered:** "Knowing they made a positive difference" — dropped because it's downstream of the app; "data and information" — too feature-focused, not a benefit.
- **What would change my mind:** If users say they can already get this data easily elsewhere, or that they don't actually use population data to make decisions.
